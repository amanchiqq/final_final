        ...
        <div class="card-body">
          <form method="POST" action="{{ route('admin.store') }}">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input id="user_iin" type="text" class="form-control @error('user_iin') is-invalid @enderror" name="user_iin" value="{{ old('user_iin') }}" required autocomplete="user_iin" autofocus>
